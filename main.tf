...
module "linux" {
  ...
  nb_count       = 2
  linux_name     = "n01580095-c-vm"
  linux_size     = "Standard_B1s"
  admin_username = "n01580095"
  public_key     = "/home/n01580095/.ssh/id_rsa.pub"
  priv_key       = "/home/n01580095/.ssh/id_rsa"
  location       = module.resource_group.location
...
locals {
  common_tags = {
    ...
    Project      = "Learning"
    ContactEmail = "n01580095@humber.ca"
    Environment  = "Lab"
  }
